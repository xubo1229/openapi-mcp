...
type CallToolResult struct {
	...
	// The result type of the tool call
	ResultType string `json:"resultType,omitempty"`
	// The input schema for the tool (JSON Schema)
	Schema map[string]any `json:"schema,omitempty"`
	// The arguments used for this tool call
	Arguments map[string]any `json:"arguments,omitempty"`
	// Example usages for this tool
	Examples []any `json:"examples,omitempty"`
	// Usage instructions or tips for this tool
	Usage string `json:"usage,omitempty"`
	// Suggested next steps or commands for the user/agent
	NextSteps []string `json:"next_steps,omitempty"`
	// If true, this result is partial and more data may follow (for streaming/multi-step tools)
	Partial bool `json:"partial,omitempty"`
	// If set, this token can be used to resume or continue the operation
	ResumeToken string `json:"resume_token,omitempty"`
	// Output format: "structured" (e.g., JSON) or "unstructured" (e.g., plain text)
	OutputFormat string `json:"output_format,omitempty"`
	// Output type: e.g., "json", "text", "table", etc.
